 ...
 * <a title="收藏本站" href="javascript:;" onClick="addFavoritepage('H-ui前端框架','https://www.liaotaoo.cn/');">收藏本站</a>
...
!function($) {
	$.fn.Huifold = function(options){
		var defaults = {
			...
			type:2,//1	只打开一个，可以全部关闭;2	必须有一个打开;3	可打开多个
			trigger:'click',
			className:"selected",
			speed:'first',
		};

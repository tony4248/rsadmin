<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\email\add.html";i:1559019684;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    <article class="cl pd-20">
        <form action="<?php echo url('email/add'); ?>" method="post" class="form form-horizontal form-email-add">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>收件人ID：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo $receiver; ?>" placeholder="收件人的ID,发给系统用ID:000001,广播消息用ID:999999" id="receiver" name="receiver">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3">发件人ID：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="收件人的ID,如果留空,则使用系统ID:000001" id="sender" name="sender">
                </div>
            </div>
            <div class="row cl">

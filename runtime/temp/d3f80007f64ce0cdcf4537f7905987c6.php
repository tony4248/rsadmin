<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\shop\index.html";i:1559023004;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\header.html";i:1559023139;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\menu.html";i:1559023294;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <table style="white-space: nowrap;word-break:keep-all;" class="table table-border table-bordered table-hover table-bg table-sort" id="table">
                        ...
                        <tbody>
                            ...
                            <tr class="text-c">
                                ...
                                <td><?php if($vo['type'] == 'CARD'): ?>钻石<?php elseif($vo['type'] == 'COIN'): ?>金币<?php elseif($vo['type'] == 'PROPS'): ?>道具<?php elseif($vo['type'] == 'COMMODITY'): ?>实物<?php else: ?>未知<?php endif; ?></td>
                                <td><?php echo $vo['qty']; ?></td>
                                <td><?php echo $vo['price']; ?></td>
                                <td><?php if($vo['currencyType'] == 'RMB'): ?>RMB<?php elseif($vo['currencyType'] == 'CARD'): ?>钻石<?php elseif($vo['type'] == 'COIN'): ?>金币<?php else: ?>未知<?php endif; ?></td>
                                <td class="td-manage">
                                    <a title="编辑" href="javascript:;" onclick="edit_product('商品编辑','/admin.php/admin/shop/edit_product?id=<?php echo $vo['id']; ?>','1','800','500')" class="<?php if($vo['id'] == 1): ?>btn disabled radius size-MINI<?php else: ?>ml-5 btn btn-warning-outline radius size-MINI<?php endif; ?>" style="text-decoration:none">编辑</a>
                                    <a title="删除" href="javascript:;" onclick="del_product('<?php echo $vo['id']; ?>')" class="ml-5 btn btn-danger-outline radius size-MINI" style="text-decoration:none">删除</a>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>

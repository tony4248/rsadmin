<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:78:"C:\inetpub\wwwroot\rsadmin\public/../application/admin\view\message\index.html";i:1559023003;s:66:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\meta.html";i:1552892653;s:68:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\header.html";i:1560386155;s:66:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\menu.html";i:1559023294;s:68:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
                ...
                <table class="table table-border table-bordered table-bg">
                    ...
                    <tbody>
                        ...
                        <tr class="text-c">
                            ...
                            <td class="td-status">
                                <?php if($vo['persistent'] == true): ?><span class="label label-warning radius">是</span> <?php else: ?><span class="label label-success radius">否</span> <?php endif; ?>
                            </td>
                            <td><?php echo $vo['createdDate']; ?></td>
                            <td class="td-manage">
                                <a title="删除" href="javascript:;" onclick="message_del('<?php echo $vo['id']; ?>')" class="ml-5 btn btn-warning-outline radius size-MINI" style="text-decoration:none">删除</a></td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>

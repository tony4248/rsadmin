<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\agent\reports.html";i:1558744724;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\header.html";i:1559023139;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\menu.html";i:1559023294;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    <section class="Hui-article-box">
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="<?php echo url('index/index'); ?>">首页</a> <span class="c-gray en">&gt;</span> 代理管理 <span class="c-gray en">&gt;</span> 业绩报表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);"
                title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
        <div class="Hui-article">
            <article class="cl pd-20">
                <form class="form-inline" role="form" method="get" action="<?php echo url('agent/search'); ?>">
                    <div class="form-group">
                        <span style="color: red;">代理查询</span> 用户Id:<input style="width: 120px;" type="text" class="input-text" name="userId" placeholder="请输入用户Id" value="<?php echo !empty($userId)?$userId : '';; ?>">
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-bordered table-hover table-bg" id="mytable">
                            ...
                            <tbody>
                                ...
                                <tr class="text-c">
                                    <td id="uid" width="70"><?php echo $vo['uid']; ?></td>
                                    <td><?php echo $vo['name']; ?></td>
                                    <td><?php echo $vo['availBalance']; ?></td>
                                    <td><?php echo $vo['rebateSum']; ?></td>
                                    <td><?php echo $vo['withdrawSum']; if($vo['withdrawSum'] > 0): ?><a href="javascript:;" onClick="view_records('提现记录','/admin.php/admin/agent/withdraw_records?userId=<?php echo $vo['uid']; ?>','4','','600')"> | <span
                                        style="color: #ff0000">记录</span></a><?php endif; ?>
                                    </td>
                                    ...
                                    <td class="td-manage">
                                        <a href="javascript:;" onClick="view_records('业绩记录','/admin.php/admin/agent/report_records?userId=<?php echo $vo['uid']; ?>','4','','600')" class="btn btn-secondary-outline radius size-MINI" style="text-decoration:none">业绩记录</a>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>

                            </tbody>
                            <?php echo !empty($quick)?$quick : ''; ?>
...
<script type="text/javascript" src="/static/admin/static/laydate/laydate.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#totalRow').append('<td>当前页合计</td><td style="text-align: center"><?php echo $perfSum['totalABSum']; ?></td><td style="text-align: center"><?php echo $perfSum['totalRBSum']; ?></td><td  style="text-align: center"><?php echo $perfSum['totalWRSum']; ?></td><td></td><td></td><td></td><td></td><td></td><td></td>');
        });
    </script>
    <!--/请在上方写此页面业务相关的脚本-->
</body>

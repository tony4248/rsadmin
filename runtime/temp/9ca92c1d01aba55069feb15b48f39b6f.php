<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\agent\add_withdraw.html";i:1559022994;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    <article class="cl pd-20">
        <form action="" method="post" class="form form-horizontal form-agent-adda" id="form-withdraw-add">
            <div class="row cl">
...
<script type="text/javascript" src="/static/admin/static/laydate/laydate.js"></script>
    ...
    <script type="text/javascript">
        $('#button').click(function() {
            ...
            $.ajax({
                url: "<?php echo url('agent/add_withdraw'); ?>",
                type: 'post',
                data: formData,

<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\group\index.html";i:1552892653;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\header.html";i:1552892653;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\menu.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="<?php echo url('index/index'); ?>">首页</a> <span class="c-gray en">&gt;</span> 管理员管理 <span class="c-gray en">&gt;</span> 角色管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
            ...
            <div class="mt-10">
                ...
                <table class="table table-border table-bordered table-hover table-bg">
                    ...
                    <tr class="text-c">
                        ...
                        <td><span class="btn btn-default radius" onclick="cha_kan(<?php echo $vo['id']; ?>)">点我查看管理员</span></td>
                        <td>
                        <?php if($vo['status']==0): ?><span class="label label-success radius">正常</span>
                            <?php else: ?><span class="label label-danger radius">禁用</span><?php endif; ?>

                        </td>
                        <td>
                         <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('修改权限','/admin.php/admin/group/power?id=<?php echo $vo['id']; ?>','800')"><i class="Hui-iconfont">&#xe600;</i> 分配权限</a>
                        </td>
                        <td class="f-14">
                            <a title="编辑" class="btn btn-warning-outline radius size-MINI" href="javascript:;" onclick="admin_role_edit('角色编辑','/admin.php/admin/group/edit?id=<?php echo $vo['id']; ?>','1')" style="text-decoration:none">编辑</a>
                            <a title="删除"  href="javascript:;" onclick="del(<?php echo $vo['id']; ?>)" class="ml-5 btn btn-danger-outline radius size-MINI" style="text-decoration:none">删除</a></td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>
...
<script type="text/javascript">
    ...
    function cha_kan(id){
        ...
        $.post("<?php echo url('group/cha_kan'); ?>", {'id':id}, function(re){
            layer.open({
                type: 1,
                title: '管理员',
                shadeClose: true,

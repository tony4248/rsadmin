<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\kefu\index.html";i:1560400099;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\header.html";i:1560386155;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\menu.html";i:1559023294;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <![endif]-->
<title>客服管理 - 客服列表 - RSCMS_V2</title>
...
<script>
    ...
    <section class="Hui-article-box">
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="<?php echo url('index/index'); ?>">首页</a>
            <span class="c-gray en">&gt;</span> 客服管理
            <span class="c-gray en">&gt;</span> 客服列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a> </nav>
        <div class="Hui-article">
            <article class="cl pd-20">
                <div class="cl pd-5 bg-1 bk-gray mt-20">
                    <span class="l"> <a href="javascript:;" onclick="kefu_add('添加客服','/admin.php/admin/kefu/add','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加客服</a> </span>
                </div>
                <table class="table table-border table-bordered table-bg">
                    <thead>
                        <tr>
                            <th scope="col" colspan="9">客服列表</th>
                        </tr>
                        <tr class="text-c">
                            <th width="70">ID</th>
                            <th width="200">内容</th>
                    ...
                    <tbody>
                        ...
                        <tr class="text-c">
                            ...
                            <td class="td-manage">
                                <a title="编辑" href="javascript:;" onclick="kefu_add('编辑','/admin.php/admin/kefu/edit?id=<?php echo $vo['id']; ?>','800','500')" class="ml-5 btn btn-success-outline radius size-MINI" style="text-decoration:none">编辑</a>
                                <a title="删除" href="javascript:;" onclick="kefu_del('<?php echo $vo['id']; ?>')" class="ml-5 btn btn-warning-outline radius size-MINI" style="text-decoration:none">删除</a></td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>
...
<script type="text/javascript" src="/static/admin/static/laydate/laydate.js"></script>
    ...
    <script type="text/javascript">
        /*客服-增加*/
        function kefu_add(title, url, w, h) {
            layer_show(title, url, w, h);
        }
        /*客服-删除*/

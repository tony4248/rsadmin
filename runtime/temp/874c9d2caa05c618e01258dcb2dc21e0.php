<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\top_info\add.html";i:1552892653;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="cl pd-20">
    <form action="" method="post" class="form form-horizontal form-admin-adds" id="form-top-info-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>消息内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="information" class="textarea radius"></textarea>
            </div>
        </div>
        <div class="row cl">
...
<script>
    $('#button').click(function () {
        var formData  = $('#form-top-info-add').serialize();
        console.log(formData);
        $.ajax({
            url:"<?php echo url('top_info/info_save'); ?>",
            type:'post',
            data:formData,

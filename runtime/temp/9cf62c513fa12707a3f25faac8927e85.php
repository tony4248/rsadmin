<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\club\transfer_club.html";i:1558875675;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <![endif]-->
<title>俱乐部管理 - 转移俱乐部 - TXCMS_V2</title>
...
<body>
    <article class="cl pd-20">
        <form action="<?php echo url('club/transfer_club'); ?>" method="post" class="form form-horizontal">
            <input type="hidden" value="<?php echo $data['id']; ?>" name="id">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>转移代理名</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="目标用户的Id,用户必须具有代理资格" id="uid" name="uid">
                </div>
            </div>
            <div class="row cl">

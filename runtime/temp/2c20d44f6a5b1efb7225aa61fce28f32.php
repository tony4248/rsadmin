<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\email\reply.html";i:1558967643;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    <article class="cl pd-20">
        <form action="<?php echo url('email/reply'); ?>" method="post" class="form form-horizontal form-email-add">
            <input type="hidden" name="receiver" value="<?php echo $data['sender']; ?>">
            <input type="hidden" name="sender" value="<?php echo $data['receiver']; ?>">
            <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>收件人ID：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" disabled="disabled" value="<?php echo $data['sender']; ?>" placeholder="" id="receiver" name="receiver">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3">发件人ID：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" disabled="disabled" value="<?php echo $data['receiver']; ?>" placeholder="" id="sender" name="sender">
                </div>
            </div>
            <div class="row cl">

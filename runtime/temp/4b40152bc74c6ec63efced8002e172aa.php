<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\email\index.html";i:1558963661;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\header.html";i:1552892653;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\menu.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <![endif]-->
<title>邮件管理 - 邮件列表 - TXCMS_V2</title>
    ...
    <section class="Hui-article-box">
        ...
        <div class="Hui-article">
            <article class="cl pd-20">
                ...
                <form class="form-inline" role="form" method="get" action="<?php echo url('email/search'); ?>">
                    <div class="form-group">
                        <span style="color: red;">查询</span> 收件人Id:
                        <input style="width: 120px;" type="text" class="input-text" name="receiver" placeholder="请输入收件人Id" value="<?php echo !empty($receiver)?$receiver : '';; ?>">发件人Id:
                        <input style="width: 120px;" type="text" class="input-text" name="sender" placeholder="发件人Id" value="<?php echo !empty($sender)?$sender : '';; ?>">
                    </div>
                ...
                <table class="table table-border table-bordered table-bg">
                    ...
                    <tbody>
                        ...
                        <tr class="text-c">
                            ...
                            <td class="td-status">
                                <?php if($vo['read'] == 0): ?><span class="label label-warning radius">未读</span> <?php else: ?><span class="label label-success radius">已读</span> <?php endif; ?>
                            </td>
                            <td><?php echo $vo['sentDate']; ?></td>
                            <td><?php echo $vo['receivedDate']; ?></td>
                            <td class="td-manage">
                                <a title="编辑" href="javascript:;" onclick="email_reply('回复','/admin.php/admin/email/reply?id=<?php echo $vo['id']; ?>','1','800','500')" class="ml-5 btn btn-success-outline radius size-MINI" style="text-decoration:none">回复</a>

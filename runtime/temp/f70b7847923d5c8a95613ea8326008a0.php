<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:77:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\agent\withdraw.html";i:1559022996;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\header.html";i:1559023139;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\menu.html";i:1559023294;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<title>代理管理 - 提佣管理 - RSCMS_V2</title>
...
<script>
    ...
    <section class="Hui-article-box">
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="<?php echo url('index/index'); ?>">首页</a> <span class="c-gray en">&gt;</span> 代理管理 <span class="c-gray en">&gt;</span> 提佣管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);"
                    ...
                    <div class="table-responsive">
                        <table style="white-space: nowrap;word-break:keep-all;" class="table table-border table-bordered table-hover table-bg table-sort" id="table">
                            ...
                            <tr class="text-c">
                                ...
                                <td class="td-manage">
                                    <a href="javascript:;" onClick="withdraw_edit('编辑提佣记录','/admin.php/admin/agent/edit_withdraw?uid=<?php echo $vo['uid']; ?>&oid=<?php echo $vo['id']; ?>','4','','400')" class="btn btn-primary-outline radius size-MINI" style="text-decoration:none">编辑</a>
                                    <a <?php if($vo['state'] == 'PROCESSED'): ?>hidden<?php else: endif; ?> href="javascript:;" onclick="withdraw_del(<?php echo $vo['uid']; ?>, '<?php echo $vo['id']; ?>')" class="btn btn-danger-outline radius size-MINI" style="text-decoration:none">删除</a></td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </table>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function withdraw_add_s(title, url, id, w, h) {
            layer.open({
                ...
                area: ['480px', '550px'],
                shadeClose: true,
                content: '/admin.php/admin/agent/add_withdraw'
            });
        }
        /*卡号-编辑*/
        ...
        function withdraw_del(uid, oid) {
            layer.confirm('确定要删除吗？', {
                ...
                $.ajax({
                    url: "<?php echo url('agent/del_withdraw'); ?>",
                    type: 'post',
                    data: {
                        'uid': uid,
                        'oid': oid,

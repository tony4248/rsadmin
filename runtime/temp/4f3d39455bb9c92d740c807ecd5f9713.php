<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\robot\index.html";i:1560398692;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\header.html";i:1560386155;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\menu.html";i:1559023294;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    <section class="Hui-article-box">
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="<?php echo url('index/index'); ?>">首页</a> <span class="c-gray en">&gt;</span> 机器人管理 <span class="c-gray en">&gt;</span> 会员列表<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);"
                title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
        <div class="Hui-article">
            <article class="cl pd-20">
                <div class="cl pd-5 bg-1 bk-gray mt-20" style="margin-top: 0px;">
                    <div class="l">
                        <div><a onclick='user_add_s();' class='btn btn-success-outline radius'><i class='Hui-iconfont'>&#xe600;</i> 添加机器人</a></div>
                    </div>
                </div>
                <form class="form-inline" role="form" method="get" action="<?php echo url('robot/index'); ?>">
                    <div class="form-group">
                        <span style="color: red;">机器人查询</span>账号:<input style="width: 120px;" type="text" class="input-text" name="username" placeholder="请输入账号" value="<?php echo !empty($username)?$username : '';; ?>">
                    </div>
                    ...
                    <div class="table-responsive">
                        <table style="white-space: nowrap;word-break:keep-all;" class="table table-border table-bordered table-hover table-bg table-sort" id="table">
                            ...
                            <tr class="text-c">
                                ...
                                <td>
                                    <a href="javascript:;" onClick="member_charge('充值','/admin.php/admin/robot/user_charge?id=<?php echo $vo['id']; ?>','4','','400')" class="ml-5 btn btn-success-outline radius size-MINI" style="text-decoration:none">充值</a>
                                    <a href="javascript:;" onClick="member_edit('编辑','/admin.php/admin/robot/edit?id=<?php echo $vo['id']; ?>','4','','400')" class="ml-5 btn btn-success-outline radius size-MINI" style="text-decoration:none">编辑</a>
    ...
    <script type="text/javascript">
        ...
        function member_add_user(id) {
            layer.open({
                ...
                title: '机器人添加',
                shadeClose: true,
                content: '/admin.php/admin/robot/add?id=' + id //这里content是一个DOM，注意：最好该元素要存放在body最外层，否则可能被其它的相对元素所影响
            });
        }
        ...
        function user_add_s() {
            layer.open({
                ...
                area: ['480px', '510px'],
                shadeClose: true,
                content: '/admin.php/admin/robot/user_add'
            });
        }
    </script>
    <!--/请在上方写此页面业务相关的脚本-->

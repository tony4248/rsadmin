<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"C:\inetpub\wwwroot\rsadmin\public/../application/admin\view\user\loginlogs.html";i:1560396994;s:66:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\meta.html";i:1552892653;s:68:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\header.html";i:1560386155;s:66:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\menu.html";i:1559023294;s:68:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<title>用户管理 - 登录日志 - RSCMS_V2</title>
        ...
        <div class="Hui-article">
            <article class="cl pd-20">
                <table class="table table-border table-bordered table-bg">
                    <form class="form-inline" role="form" method="get" action="<?php echo url('user/loginlogs'); ?>">
                        <div class="form-group">
                            <span style="color: red;">日志查询</span> 账号:<input style="width: 120px;" type="text" class="input-text" name="userId" placeholder="请输入账号" value="<?php echo !empty($userId)?$userId : '';; ?>">
                        </div>
...
<script type="text/javascript" src="/static/admin/static/laydate/laydate.js"></script>
    ...
    <script>
        $('#clearLoginLogs').click(function() {
            $.ajax({
                type: 'post',
                url: "<?php echo url('user/clearLoginLogs'); ?>",
                success: function(res) {
                    if (res.code === 0) {
                        //失败
                        layer.msg(res.msg, {

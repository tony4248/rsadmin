<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"C:\inetpub\wwwroot\rsadmin\public/../application/admin\view\admin\index.html";i:1559023981;s:66:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\meta.html";i:1552892653;s:68:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\header.html";i:1560386155;s:66:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\menu.html";i:1559023294;s:68:"C:\inetpub\wwwroot\rsadmin\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
                ...
                <table class="table table-border table-bordered table-bg">
                    ...
                    <tbody>
                        ...
                        <tr class="text-c">
                            ...
                            <td>
                                <?php if($vo['status'] == 0): ?><span class="label label-success radius">正常</span> <?php else: ?><span class="label label-danger radius">禁用</span> <?php endif; ?>
                            </td>
                            <td class="td-manage">

                                <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','/admin.php/admin/admin/edit?id=<?php echo $vo['id']; ?>','1','800','500')" class="<?php if($vo['id'] == 1): ?>btn disabled radius size-MINI<?php else: ?>ml-5 btn btn-warning-outline radius size-MINI<?php endif; ?>" style="text-decoration:none">编辑</a>
                                <a title="改密" href="javascript:;" onclick="admin_change_password('管理员改密','/admin.php/admin/admin/adminChangePasswords?id=<?php echo $vo['id']; ?>','1','800','300')" class="ml-5 btn btn-success-outline radius size-MINI" style="text-decoration:none">改密</a>
                                <a title="删除" href="javascript:;" onclick="admin_del(<?php echo $vo['id']; ?>)" class="ml-5 btn btn-danger-outline radius size-MINI" style="text-decoration:none">删除</a>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
    ...
    <script type="text/javascript">
        ...
        function admin_del(id) {
            layer.confirm('确定要删除管理员？', {
                ...
                $.post('/admin.php/admin/admin/del', {
                    'id': id
                }, function(res) {
                    if (res.code === 0) {
                        layer.msg(res.msg, {

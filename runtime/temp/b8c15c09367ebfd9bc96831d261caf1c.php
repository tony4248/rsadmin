<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:77:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\admin\loginlog.html";i:1559022994;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\header.html";i:1560386155;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\menu.html";i:1559023294;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="Hui-article">
            <article class="cl pd-20">
                <table class="table table-border table-bordered table-bg">
                    <form class="form-inline" role="form" method="get" action="<?php echo url('admin/loginlog'); ?>">
...
<script type="text/javascript" src="/static/admin/static/laydate/laydate.js"></script>
    ...
    <script>
        $('#clearAdminLog').click(function() {
            $.ajax({
                type: 'post',
                url: "<?php echo url('admin/clearAdminLog'); ?>",
                success: function(res) {
                    if (res.code === 0) {
                        //失败
                        layer.msg(res.msg, {

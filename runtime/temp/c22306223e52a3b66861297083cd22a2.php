<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"C:\inetpub\wwwroot\qipai\public/../application/admin\view\robot\edit.html";i:1559023003;s:64:"C:\inetpub\wwwroot\qipai\application\admin\view\common\meta.html";i:1552892653;s:66:"C:\inetpub\wwwroot\qipai\application\admin\view\common\footer.html";i:1552892653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    <article class="cl pd-20">
        <form action="<?php echo url('robot/edit'); ?>" method="post" class="form form-horizontal">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                    <div class="radio-box">
                        <input name="sex" type="radio" value=0 <?php if($data['sex'] == 0): ?> checked <?php endif; ?>>
                        <label for="sex-1">女</label>
                    </div>
                    <div class="radio-box">
                        <input name="sex" type="radio" value=1 <?php if($data['sex'] == 1): ?> checked <?php endif; ?>>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                    <div class="radio-box">
                        <input name="locked" type="radio" value=0 <?php if($data['locked'] == 0): ?> checked <?php endif; ?>>
                        <label for="sex-1">否</label>
                    </div>
                    <div class="radio-box">
                        <input name="locked" type="radio" value=1 <?php if($data['locked'] == 1): ?> checked <?php endif; ?>>
